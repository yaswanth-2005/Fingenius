...
const Navbar = () => {
  ...
  const handleLogout = () => {
    ...
    // Remove user data from localStorage (if needed)
  ...
  return (
    ...
    >
      ...
      <div
        className={`md:hidden absolute top-full left-0 w-full bg-background/95 backdrop-blur-md shadow-md transition-all ${
