...
const coursesData: Course[] = [
  {
    ...
    description:
      "Learn the basics of investment and build a solid foundation for your financial journey.",
    thumbnailUrl:
    ...
    modules: [
      {
        ...
        description: "Introduction to investment.",
      },
      {
        id: "module-1-2",
        title: "Risk Management",
        videoUrl: "https://www.youtube.com/embed/dCWWdO4JnqQ",
        description: "Understanding risk in investment.",
      },
    ],
  },
  {
