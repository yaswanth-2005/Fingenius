                  ...
                  <Tabs defaultValue="payment" className="w-full">
                    ...
                    <TabsContent value="payment" className="space-y-4">
                      ...
                      {paymentMethod === "crypto" && (
                        ...
                        >
                          <div className="border border-dashed border-muted-foreground p-6 rounded-lg">
                            <p className="font-mono text-sm">bc1qxy2kgdygjrsqtzq2n0yrf2493p83kkfjhx0wlh</p>
                          </div>
                          <p className="text-sm text-muted-foreground">Send the exact amount to this wallet address</p>
                          <div className="grid gap-2 w-full">
                            <Label htmlFor="tx-id">Transaction ID (After Payment)</Label>
